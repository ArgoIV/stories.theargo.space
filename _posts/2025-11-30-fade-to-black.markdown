...
image:
  path: /assets/images/tara/fade_to_black_preview.webp
  alt: Line art trawing showing Tara leaning against a desk.
  lqip: data:image/webp;base64,UklGRioAAABXRUJQVlA4IB4AAAAwAQCdASoQAAgAADBMI5QAA3AA/vcjMEjFESAAAAA=
---
![Tara Chess](/assets/images/tara/fade_to_black.webp){: lqip="data:image/webp;base64,UklGRiYAAABXRUJQVlA4IBoAAAAwAQCdASoLABAAAvBMI5QAA3AA/vdRIQLgAA==" alt="Line art trawing showing Tara leaning against a desk." }
_Tara Mason a week before her 40th birthday_

{%
  include embed/audio.html
  src='/assets/music/charon.ogg'
  types='mp3'
  title='Yehezkel Raz - Charon'
%}
